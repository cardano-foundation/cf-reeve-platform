...
class CreateReportViewTest {
    ...
    void fromReportRequest_WithBalanceSheet_ShouldPopulateBalanceSheetData() {
        ...
        when(reportRequest.getTangibleAssets()).thenReturn("1000");
        ...
        when(reportRequest.getOtherShortTermLiabilities()).thenReturn("70");
        ...
        assertEquals(new BigDecimal("1000"), assets.getNonCurrentAssets().get().getTangibleAssets().get());
        ...
        assertEquals(new BigDecimal("70"), liabilities.getCurrentLiabilities().get().getOtherShortTermLiabilities().get());
    ...
    void fromReportRequest_WithIncomeStatement_ShouldPopulateIncomeStatementData() {
        ...
        when(reportRequest.getExternalServices()).thenReturn("200");
        ...
        when(reportRequest.getDirectTaxes()).thenReturn("60");
        ...
        assertEquals(new BigDecimal("60"), data.getTaxExpenses().get().getDirectTaxes().get());
        ...
        assertEquals(new BigDecimal("200"), data.getCostOfGoodsAndServices().get().getExternalServices().get());
    }
