...
INSERT INTO accounting_core_transaction
    (transaction_id, type, batch_id, processing_status, entry_date, accounting_period,
     transaction_internal_number, organisation_id, organisation_name, organisation_country_code,
     organisation_tax_id_number, organisation_currency_id,
     ...
     total_amount_lcy, item_count, ledger_dispatch_status_error_reason, rollback_suffix, excluded_report)
VALUES ('VALIDATED_TRANSACTION', 'VendorBill',
        ...
        'system', 'system', '2024-11-11 13:15:28.10435', '2024-11-11 13:15:28.10435', 'NETSUITE', 0.0, 0, NULL, NULL, NULL);
...
VALUES ('Pending_by_rejection', 'CardCharge',
        ...
        '75f95560c1d883ee7628993da5adf725a5d97a13929fd4f477be0faf5020ca94', 'Cardano Foundation', 'CH', 'CHE-184477354',
        'ISO_4217:CHF', NULL, NULL, NULL, NULL, NULL, 'VALIDATED', false, false, 'NOT_DISPATCHED', null, null, 'NOK',
        'system', 'system', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'NETSUITE', 0.0, 0, NULL, NULL, NULL);
INSERT INTO accounting_core_transaction_batch_assoc
