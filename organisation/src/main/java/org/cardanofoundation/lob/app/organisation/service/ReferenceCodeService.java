...
public class ReferenceCodeService {
    ...
    @Transactional
    public Optional<ReferenceCodeView> upsertReferenceCode(String orgId, ReferenceCodeUpdate referenceCodeUpdate) {
        ...
        return Optional.ofNullable(ReferenceCodeView.fromEntity(referenceCode));
    }
}
