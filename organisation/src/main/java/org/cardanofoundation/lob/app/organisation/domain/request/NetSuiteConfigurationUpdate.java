...
public class NetSuiteConfigurationUpdate {
    ...
    /**
     * Optional. Blank or absent keeps the key already stored by the netsuite module — the
     * organisation module holds no copy of it.
     */
    @ToString.Exclude
    @Schema(description = "PKCS#8 PEM private key. Leave empty to keep the existing key.")
