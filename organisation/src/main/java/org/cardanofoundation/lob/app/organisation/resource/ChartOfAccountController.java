...
public class ChartOfAccountController {
    ...
    public ResponseEntity<List<OrganisationChartOfAccountTypeView>> getChartOfAccountType(@PathVariable("orgId") @Parameter(example = "75f95560c1d883ee7628993da5adf725a5d97a13929fd4f477be0faf5020ca94") String orgId) {
                    ...
                    return new OrganisationChartOfAccountTypeView(
                            ...
                            chartOfAccountType.getSubType().stream().map(chartOfAccountSubType -> {
                                return new OrganisationChartOfAccountSubTypeView(
                                        ...
                                        chartOfAccountsService.getBySubTypeId(chartOfAccountSubType.getId()).stream().map(chartOfAccount -> {
    ...
    @GetMapping(value = "/{orgId}/chart-of-account", produces = "application/json")
    public ResponseEntity<?> getChartOfAccount(@PathVariable("orgId") @Parameter(example = "75f95560c1d883ee7628993da5adf725a5d97a13929fd4f477be0faf5020ca94") String orgId) {
    ...
    @PostMapping(value = "/{orgId}/chart-of-account", produces = "application/json")
    public ResponseEntity<?> upsertChartOfAccount(@PathVariable("orgId") @Parameter(example = "75f95560c1d883ee7628993da5adf725a5d97a13929fd4f477be0faf5020ca94") String orgId,
        ...
        Optional<OrganisationChartOfAccountView> referenceCode = chartOfAccountsService.upsertChartOfAccount(orgId, chartOfAccountUpdate);
        if (referenceCode.isEmpty()) {
            ThrowableProblem issue = Problem.builder()
                    .withTitle("REFERENCE_CODE_NOT_FOUND")
                    .withDetail(STR."Unable to find customer code by Id: \{orgId} and \{chartOfAccountUpdate.getCustomerCode()}")
                    .withStatus(Status.NOT_FOUND)
                    .build();
