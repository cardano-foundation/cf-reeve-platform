...
class OrganisationServiceTest {
    ...
    void testGetOrganisationView() {
        ...
        when(projectCodeService.getAllProjects(anyString(), eq(null), eq(null), eq(null), eq(null), eq(Pageable.unpaged()))).thenReturn(Either.right(List.of(mock(ProjectView.class))));
        ...
        verify(projectCodeService).getAllProjects(anyString(), eq(null), eq(null), eq(null), eq(null),eq(Pageable.unpaged()));
